...
const createRpcVm = require('fourtwentyjs-vm/dist/hooked').fromWeb3Provider
const fourtwentyUtil = require('fourtwentyjs-util')
// using local copy pending https://github.com/fourtwentyjs/fourtwentyjs-block/pull/24
const materializeBlock = require('./materialize-blocks')
// const materializeBlock = require('fourtwentyjs-block/from-rpc')
...
function createVmTraceStream(provider, txHash){
  ...
  const query = new FourtwentyQuery(provider)
